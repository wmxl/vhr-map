...
public class testLuence {
    ...
    public void testCreate() throws Exception {
        ...
        document.add(new StringField("id", "59", Field.Store.YES));
        // 这里我们title字段需要用TextField，即创建索引又会被分词。StringField会创建索引，但是不会被分词
        document.add(new TextField("title", "四川省绵阳市鸿永盛模塑有限公司", Field.Store.YES));
    ...
    public void testCreate2() throws Exception{
        ...
        document1.add(new TextField("title", "四川省绵阳市鸿永盛模塑有限公司", Field.Store.YES));
        document1.add(new TextField("address", "绵阳市安州区花荄镇工业园区青安片纵一路11号", Field.Store.YES));
        docs.add(document1);
        // 创建文档对象
        Document document2 = new Document();
        document2.add(new StringField("id", "2", Field.Store.YES));
        document2.add(new TextField("title", "四川三鑫南蕾气门座制造有限公司", Field.Store.YES));
        ...
        document3.add(new TextField("title", "清远市新业电器有限公司", Field.Store.YES));
        ...
        document4.add(new TextField("title", "四川科盛汽车零部件制造有限公司", Field.Store.YES));
        ...
        document5.add(new TextField("title", "四川国跃新能源汽车", Field.Store.YES));
    ...
    public void testSearch() throws Exception {
        ...
        QueryParser parser = new QueryParser("测试标题", new IKAnalyzer());
        // 创建查询对象
        Query query = parser.parse("传媒");
    ...
    public void testTermQuery() throws Exception {
        // 创建词条查询对象
        Query query = new TermQuery(new Term("title", "汽车"));
        search(query);
    }
...
//    Query query = new FuzzyQuery(new Term("title","fscevool"));
        ...
        Query query = new FuzzyQuery(new Term("title","传媒公司"),2); //中文貌似不行，如谷歌傻逼
        search(query);
    }
    ...
    public void testBooleanQuery() throws Exception{
        ...
        Query query3 = new TermQuery(new Term("title", "传媒"));
        Query query4 = new TermQuery(new Term("title", "公司"));

        Query query5 = new TermQuery(new Term("title", "汽车"));
        Query query6 = new TermQuery(new Term("address", "工业"));

        // 创建布尔查询的对象
        BooleanQuery query = new BooleanQuery();
        // 组合其它查询
        query.add(query5, BooleanClause.Occur.SHOULD);
        query.add(query6, BooleanClause.Occur.SHOULD);
